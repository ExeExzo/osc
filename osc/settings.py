...
# Local static files (optional)
STATICFILES_DIRS = [BASE_DIR / "static"]

# Production static root (where collectstatic will copy files)
...
ACCOUNT_EMAIL_VERIFICATION = "none"  # или "mandatory" если потом подключишь почту
